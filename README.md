...
This repository is the student release point for the ENGR 102 Summer Bridge materials.
...
- [Public access manifest](MANIFEST_STUDENT_ACCESS.md)
- [Repository hygiene report](REPOSITORY_HYGIENE.md)

## License

Unless otherwise noted, this collection is licensed under the [Creative Commons Attribution-NonCommercial-NoDerivatives 4.0 International Public License](LICENSE.md).
