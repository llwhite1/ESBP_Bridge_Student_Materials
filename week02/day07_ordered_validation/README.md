...
- [DAY07_LAB_ALIGNED_WORKBOOK_STUDENT_07202026_v5.pdf](DAY07_LAB_ALIGNED_WORKBOOK_STUDENT_07202026_v5.pdf) — current July 20 v5 student workbook.
- [DAY07_LAB_ALIGNED_WORKBOOK_INSTRUCTOR_KEY_07202026_v5.pdf](DAY07_LAB_ALIGNED_WORKBOOK_INSTRUCTOR_KEY_07202026_v5.pdf) — released blue-answer workbook key.
- [DAY07_INDEPENDENCE_RAMP_QUIZ_STUDENT_07202026_v5.pdf](DAY07_INDEPENDENCE_RAMP_QUIZ_STUDENT_07202026_v5.pdf) — released student quiz.
- [DAY07_INDEPENDENCE_RAMP_QUIZ_INSTRUCTOR_KEY_07202026_v5.pdf](DAY07_INDEPENDENCE_RAMP_QUIZ_INSTRUCTOR_KEY_07202026_v5.pdf) — released blue-answer quiz key with explanations.

Earlier Day 7 versions and released legacy keys are in the [archive](../../archive/legacy_daily_materials_through_20260717/day07/).
...
Preserve rule order and reject invalid evidence safely.
...
- Focus: Ordered validation.
- Main evidence to keep: validation order, rejected cases, accepted branch.
- Why it matters: Preserve rule order and reject invalid evidence safely.

## Before class / during class / after class

- Before class: List the validation rules in order.
- During class: Check invalid or risky cases before normal cases.
- After class: Name one case that would fail if the order changed.

## If you get stuck

If stuck, trace the same case through the first two rules only.
...
This builds the semester habit of using guard conditions deliberately.
